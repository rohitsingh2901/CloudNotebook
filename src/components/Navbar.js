...
const Navbar = () => {
  ...
  <Link className="navbar-brand mb-4" to="/"><img className='w-20 ml-6 mr-2' src='cloud.png' alt='logo'></img></Link>
  ...
  <div className="collapse navbar-collapse mb-4" id="navbarSupportedContent">
    <ul className="navbar-nav mr-auto">
      ...
      {localStorage.getItem("token") ? (<li className={`navbar-brand ${location.pathname==='/saves' ? 'active' : '' }`}>
        <Link className="nav-link" to="/saves">My Saves</Link>
      </li>) : ('') }
